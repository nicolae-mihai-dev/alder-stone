		...
		array(
			...
			'fields'   => array(
				...
				array(
					...
					'type'          => 'image',
					'instructions'  => __( 'First project-gallery image. Recommended: 1536 × 1280 px.', 'alder-stone' ),
					'return_format' => 'id',
					'preview_size'  => 'medium_large',
				),
				array(
					...
					'type'          => 'image',
					'instructions'  => __( 'Second project-gallery image. Recommended: 1536 × 1280 px.', 'alder-stone' ),
					'return_format' => 'id',
					'preview_size'  => 'medium_large',
				),
				array(
					'key'           => 'field_alder_stone_project_gallery_image_3',
					'label'         => __( 'Gallery Image 3 (optional)', 'alder-stone' ),
					'name'          => 'project_gallery_image_3',
					'type'          => 'image',
					'instructions'  => __( 'Optional third project-gallery image. Recommended: 1536 × 1280 px.', 'alder-stone' ),
					'return_format' => 'id',
					'preview_size'  => 'medium_large',
				),
				array(
