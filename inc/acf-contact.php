	...
	acf_add_local_field_group(
		array(
			...
			'fields' => array(
				...
				array(
					'key'           => 'field_alder_stone_contact_hero_image',
					'label'         => __( 'Contact Hero Image', 'alder-stone' ),
					'name'          => 'contact_hero_image',
					'type'          => 'image',
					'instructions'  => __( 'Wide image displayed below the introduction and contact details. Recommended: 1800 × 800 px.', 'alder-stone' ),
					'return_format' => 'id',
